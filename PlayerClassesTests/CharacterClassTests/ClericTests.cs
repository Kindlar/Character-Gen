...
namespace PlayerClassesTests.CharacterClassTests
{
    ...
    public class ClericTests
    {
        ...
        public void GivenClericLevelSpellArrayIsReturned(int level, int[] expected) 
        {
            Player player = new Player("New Name", "Cleric", "Human", level);
        ...
        {
            Player player = new Player("NewName", "Cleric", "Human", 1);
        ...
        {
            // Arrange
            Player player = new Player("NewName", "Cleric", "Human", 4);
